...
public class GameStoreServiceLayer {
    ...
    public List<GameViewModel> getGameByEsrb(String esrb) {
        ...
        if (gameList == null)
            ...
            gameList.forEach(g -> gvmList.add(buildGameViewModel(g)));
        return gvmList;
    }
    ...
    public ConsoleViewModel getConsoleById(long id) {
        ...
        return console.map(this::buildConsoleViewModel).orElse(null);
    }
    ...
    public List<ConsoleViewModel> getConsoleByManufacturer(String manufacturer) {
        ...
        if (consoleList == null)
            ...
            consoleList.forEach(c -> cvmList.add(buildConsoleViewModel(c)));
        return cvmList;
    }
    ...
    public List<TShirtViewModel> getTShirtByColor(String color) {
        ...
        if (tShirtList == null)
            ...
            tShirtList.forEach(t -> tvmList.add(buildTShirtViewModel(t)));
        return tvmList;
    }
